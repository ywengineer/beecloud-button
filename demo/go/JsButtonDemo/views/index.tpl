...
<body>
  <header>
    <div class="description">
      这是个秒支付button的Go语言示例，使用的是Beego框架
  ...
  <script id='spay-script' src='https://jspay.beecloud.cn/1/pay/jsbutton/returnscripts?appId=c37d661d-7e61-49ea-96a5-68c34e83db3b'></script>
  <script>
